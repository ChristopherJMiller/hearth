    ...
    <Sidebar
      ...
      header={
        <div className="flex items-center gap-2.5">
          <div
            className="w-8 h-8 rounded-sm flex items-center justify-center text-white shadow-[0_0_16px_rgba(233,69,96,0.35)]"
          ...
          <div className="flex flex-col leading-tight">
            ...
            <span className="text-text-tertiary text-2xs tracking-wide">
              FLEET CONTROL
            </span>
          </div>
        </div>
