...
function SkeletonCard({ index }: { index: number }) {
  return (
    <div
      className="bg-surface border border-border-subtle rounded-md p-6 h-[200px] relative overflow-hidden animate-[fade-in_0.3s_ease_both]"
    ...
    >
      ...
      <div className="flex items-start gap-3.5">
        <div className="w-12 h-12 rounded-sm bg-surface-raised" />
...
function EmptyState({ hasSearchQuery }: { hasSearchQuery: boolean }) {
  return (
    <div className="col-span-full text-center py-24 px-5 animate-[fade-in_0.4s_ease_both]">
      <div className="w-16 h-16 mx-auto mb-5 rounded-2xl bg-surface-raised border border-border-subtle flex items-center justify-center">
        <svg
